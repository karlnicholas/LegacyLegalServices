...
<body>
  ...
  <p>Welcome to the <a href="http://op-jsec.rhcloud.com">Court Opinions</a> website.</p>
  ...
  <p><xsl:element name="a">
    <xsl:attribute name="href">http://op-jsec.rhcloud.com/optout?email=<xsl:value-of select="email"/>&quot;key=<xsl:value-of select="optoutKey"/></xsl:attribute>
    <span>Opt out of Court Opinions</span>
    </xsl:element></p>
  <p>We hope you will appreciate and enjoy this effort.</p>
