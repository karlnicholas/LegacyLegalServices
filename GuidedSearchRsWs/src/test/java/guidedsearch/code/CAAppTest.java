...
import guidedsearch.restapi.ParserInterfaceWsCa;
import statutesca.factory.CAStatutesFactory;
import statutesws.server.StatutesWSImpl;
import api.gsearch.viewmodel.SectionText;
...
public class CAAppTest {
    ...
    public void testApp() throws Exception
    {
		...
		try {
			...
			ParserInterfaceWsCa parserInterface = new ParserInterfaceWsCa(address);
